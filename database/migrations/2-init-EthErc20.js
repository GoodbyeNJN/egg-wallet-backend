module.exports = {
    up: async (queryInterface, Sequelize) => {
        ...
        */
        ...
        try {
            ...
            await queryInterface.addIndex("EthErc20", ["symbol"], { transaction });
            await queryInterface.addIndex("EthErc20", ["name"], { transaction });
            await queryInterface.addIndex("EthErc20", ["address"], { transaction });
            await queryInterface.addIndex("EthErc20", ["txHash"], { transaction });
    ...
    down: (queryInterface, Sequelize) => {
        ...
        */
        return queryInterface.dropTable("EthErc20");
    },
};
