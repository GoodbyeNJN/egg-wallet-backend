    ...
    up: async (queryInterface, Sequelize) => {
        ...
        */
        ...
        try {
            ...
            await queryInterface.addIndex("Coin", ["symbol"], { transaction });
            await queryInterface.addIndex("Coin", ["name"], { transaction });
            await queryInterface.addIndex("Coin", ["address"], { transaction });
            await queryInterface.addIndex("Coin", ["walletId"], { transaction });
